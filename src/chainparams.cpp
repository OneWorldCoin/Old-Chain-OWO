...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000011d6a9bf55c1408a238c1162f567551b9578ae29f84a53b88da37e71fda"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1547645474, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04074953056a5bf3288376082190c27201af8962ebb81dbb88dff63ae4ba26f24d02b1fd40bc6062929cfc7e224697fb8e28fca4f9fa823d741790ba1ca36cfb96");
        nDefaultPort = 32112;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 OneWorld starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1647645474;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "OneWorld for everyone - 2019";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d0ebc1dff187cbde5b5baef332df823f7286f77ec5d3458991e16c3848d6e3c6a78318a01808fff08a0bc55503efd50f63ea6912ec8c7e08cabf8aec73da8d43") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1547645474;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // OneWorld: 1 day
        nTargetSpacing = 1 * 60;  // OneWorld: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // OneWorld: 1 day
        nTargetSpacing = 1 * 60;        // OneWorld: 1 minutes
