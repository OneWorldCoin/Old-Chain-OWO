...
/** Utility functions used by the OneWorld Qt UI.
 */
namespace GUIUtil
{
...
// Render OneWorld addresses in monospace font
...
// Parse "oneworld:" URI into recipient object, return true on successful parsing
