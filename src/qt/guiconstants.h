...
#define QAPP_ORG_NAME "OneWorld"
#define QAPP_ORG_DOMAIN "oneworld.org"
#define QAPP_APP_NAME_DEFAULT "OneWorld-Qt"
#define QAPP_APP_NAME_TESTNET "OneWorld-Qt-testnet"
