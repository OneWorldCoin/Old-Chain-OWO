/* src/config/oneworld-config.h.  Generated from oneworld-config.h.in by configure.  */
/* src/config/oneworld-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ONEWORLD_CONFIG_H

#define ONEWORLD_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.oneworld.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OneWorld Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OneWorld Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "oneworld"
